...
(function ($, window, undefined) {
	...
	iView.prototype = {
		...
		startSlider: function () {
			...
			iv.slider.css('background', 'url("' + iv.defs.image.data('iview:image') + '") center top no-repeat');
		...
		addStrips: function (vertical, opts) {
			...
			for (var i = 0; i < opts.strips; i++) {
				var stripWidth = Math.round(iv.slider.width() / opts.strips),
					...
					top = ((vertical) ? (stripHeight * i) + 'px' : 'center'),
					left = ((vertical) ? 'center' : (stripWidth * i) + 'px');
				if (vertical) bgPosition = 'center -' + ((stripHeight + (i * stripHeight)) - stripHeight) + 'px';
...
$(document).ready(function(){$('#iview').iView({fx: 'top-curtain',pauseTime: 7000, pauseOnHover: true, directionNav: true, directionNavHide: false, controlNav: true, controlNavNextPrev: false, controlNavTooltip: false, nextLabel: "Próximo", previousLabel: "Anterior", playLabel: "Jugada", pauseLabel: "Pausa", timer: "Pie", timerBg: "#EEE", timerColor: "#000", timerDiameter: 40, timerPadding: 4, timerStroke: 8, timerPosition: "top-right"}); });